(function (root, factory) {
  ...
  var TEMPLATE_DEFINITIONS = [
    ...
    definition("platform_invoice", "platform_invoice_import", "financeInputs", "finance", ["sourceRowNumber"], ["dashboardUserId", "month"], "finance_placeholder", ["sourceRowNumber", "dashboardUserId", "month"]),
    definition("internal_settlement", "internal_settlement_import", "financeInputs", "finance", ["dashboardUserId", "periodStart", "periodEnd"], ["actualRiderIqama"], "finance_placeholder", ["dashboardUserId", "actualRiderIqama", "periodStart", "periodEnd"]),
    definition("rider_payout_input", "rider_payout_input_import", "financeInputs", "finance", ["dashboardUserId", "periodStart", "periodEnd"], ["actualRiderIqama"], "finance_placeholder", ["dashboardUserId", "actualRiderIqama", "periodStart", "periodEnd"]),
    definition("deduction_input", "deduction_input_import", "financeInputs", "finance", ["dashboardUserId", "reasonCode"], ["periodStart", "periodEnd"], "finance_placeholder", ["dashboardUserId", "reasonCode", "periodStart", "periodEnd"]),
    definition("adjustment_input", "adjustment_input_import", "financeInputs", "finance", ["dashboardUserId", "reasonCode"], ["periodStart", "periodEnd"], "finance_placeholder", ["dashboardUserId", "reasonCode", "periodStart", "periodEnd"]),
